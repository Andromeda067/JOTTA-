...
const unitsData: { [key: string]: any } = {
  ...
  Felicidade: {
    ...
    color: "from-black to-red-700",
    description:
      "Nossa unidade realiza sonhos desde 2020. Com excelência em nossos serviços, temos  instrutores experientes, atendimento de qualidade e toda estrutura para tornar o seu sonho em realidade 🚗❤️",
    maps: "https://www.google.com/maps/search/?api=1&query=Rua+Soulto+Maior,+443",
    features: [
      "CTO(Centro Teórico Online)",
      "Sala teórica propria",
    ...
    instructors: 9,
    vehicles: 8,
    courses: ["Primeira habilitação", "Adição de categoria", "Categoria AB", "Reciclagem", "Renovação", "Categoria C"],
  },
  jotta: {
    name: "jotta",
