        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6">
              <Link href="#unidades" className="text-foreground hover:text-primary transition-colors">
                Unidades
              </Link>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <div className="inline-block mb-6 px-4 py-2 bg-primary/10 rounded-full">
              <span className="text-primary font-semibold text-sm">🚗 Sua Habilitação Começa Aqui</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-10 max-w-3xl mx-auto text-pretty leading-relaxed">
              4 unidades estrategicamente localizadas para você. Instrutores qualificados, frota moderna e a melhor
              estrutura da região.
            </p>
      ...
      <section id="sobre" className="py-20 px-4 bg-secondary/30">
        <div className="container mx-auto max-w-6xl">
          <div
            id="features-title"
            data-animate
            className={`text-center mb-16 transition-all duration-1000 delay-100 ${isVisible["features-title"] ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
              }`}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Por que escolher a gente?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <div
                ...
                id={`feature-${index}`}
                data-animate
                className={`transition-all duration-700 ${isVisible[`feature-${index}`] ? "opacity-100 scale-100" : "opacity-0 scale-95"
                  }`}
      ...
      <section id="unidades" className="py-20 px-4">
        <div className="container mx-auto max-w-7xl">
          <div
            id="units-title"
            data-animate
            className={`text-center mb-16 transition-all duration-1000 ${isVisible["units-title"] ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
              }`}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Nossas Unidades</h2>
            <p className="text-xl text-muted-foreground text-pretty">
              Escolha a unidade mais próxima de você e comece sua <span className="bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {units.map((unit, index) => (
              <div
                ...
                id={unit.id}
                data-animate
                className={`transition-all duration-700 ${isVisible[unit.id] ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
                  }`}
              ...
              >
                <Card className="overflow-hidden hover:shadow-2xl transition-all duration-300 group border-2 hover:border-primary/50">
                  <div className="relative h-64 overflow-hidden">
                    ...
                    />
                    <div className={`absolute top-4 left-4 px-4 py-2 bg-gradient-to-r ${unit.color} rounded-full`}>
                      <span className="text-white font-bold text-sm">{unit.name}</span>
                    </div>
                  </div>
                  <CardContent className="p-6">
                    <div className="space-y-4 mb-6">
                      <div className="flex items-start gap-3">
                        ...
                        <span className="text-foreground leading-relaxed">{unit.address}</span>
                      </div>
